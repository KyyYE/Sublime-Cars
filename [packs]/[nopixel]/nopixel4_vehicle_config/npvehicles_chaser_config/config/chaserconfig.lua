...
Chaserconfig.driftscorerewardmultiplier = 0
Chaserconfig.nitrousspeedregenfactor = 0
Chaserconfig.enableautosequencial = true
Chaserconfig.enablechassissimulation = true

--- PP Calibrated by NoPixel "Ignus", with a 100mm turbo.

Chaserconfig.pp_maxptwratio = 1.9
Chaserconfig.pp_minptwratio = 0.11
Chaserconfig.pp_maxacctime = 19 -- since it's acceleration, we consider the less the better, that's why here we have a lower value than minimal.
Chaserconfig.pp_minacctime = 50
